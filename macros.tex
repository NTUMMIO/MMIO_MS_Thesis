...
\usepackage{xeCJK}
\setCJKmainfont{標楷體}[BoldFont=標楷體, ItalicFont=標楷體] 
\setCJKfamilyfont{kai}{標楷體}
\newCJKfontfamily\CJKtt{標楷體}
\setCJKmonofont{標楷體}
...
\graphicspath{{figures/}{example/}{image/}}
...
% Ensure chapter pages also have centered page number
...
\usepackage{setspace}
\newenvironment{zhspace}{\begin{spacing}{1.5}}{\end{spacing}}
\newenvironment{engspace}{\begin{spacing}{2.0}}{\end{spacing}}
